...
import { FaHome, FaUser, FaCog, FaReceipt, FaShoppingCart, FaBell } from 'react-icons/fa'; // Import icons
        ...
        <>
            ...
            <nav className="hidden md:flex bg-blue-600 text-white p-4 justify-between items-center shadow-md">
                ...
                <ul className="flex space-x-4">
                    ...
                    <li className="hover:text-gray-300 cursor-pointer" onClick={() => handleNavigation('/settings')}>
                        Settings
                    </li>
            ...
            <nav className="fixed bottom-0 left-0 right-0 bg-blue-600 text-white shadow-lg flex items-center justify-between px-4 py-2 md:hidden">
                ...
                <button onClick={() => handleNavigation('/settings')} className="flex flex-col items-center">
                    <FaCog size={20} />
